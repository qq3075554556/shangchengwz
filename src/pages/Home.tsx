    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto">
          ...
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
            {language === 'zh' 
              ...
              : 'We have multiple ready-made complete VPN source code packages that support direct deployment, commercial use, secondary development, etc.'}
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {sourcePackages.map((pkg, index) => (
              <Card key={index} className="bg-card border-border overflow-hidden hover:border-primary/50 transition-all">
      ...
      <section id="custom" className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {customAdvantages.map((advantage, index) => (
      ...
      <section id="nodes" className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {nodePlans.map((plan, index) => (
              <Card key={index} className={`bg-card border-border hover:border-primary/50 transition-all relative ${plan.recommended ? 'border-primary shadow-glow' : ''}`}>
                {plan.recommended && (
                  <Badge className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-primary">
